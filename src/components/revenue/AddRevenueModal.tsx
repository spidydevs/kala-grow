...
import RevenueService, { REVENUE_TYPES, REVENUE_CATEGORIES } from '@/services/revenueService'
...
export function AddRevenueModal({ open, onOpenChange, onSuccess, users }: AddRevenueModalProps) {
  ...
  const addRevenueMutation = useMutation({
    mutationFn: RevenueService.addRevenue,
    onSuccess: () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!formData.user_id || !formData.revenue_amount || !formData.revenue_source || !formData.revenue_type) {
    ...
    addRevenueMutation.mutate({
      ...
      revenue_type: formData.revenue_type as any,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Add a new revenue entry for a team member
          </DialogDescription>
        </DialogHeader>
